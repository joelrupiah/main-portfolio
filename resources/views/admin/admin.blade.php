...
<head>
    ...
    <!-- meanmenu CSS
		============================================ -->
    <link rel="stylesheet" href="/backend/css/meanmenu/meanmenu.min.css">
    <!-- animate CSS
		============================================ -->
    ...
    <!-- jvectormap CSS
		============================================ -->
    <link rel="stylesheet" href="/backend/css/jvectormap/jquery-jvectormap-2.0.3.css">
    <!-- notika icon CSS
		============================================ -->
    <link rel="stylesheet" href="/backend/css/notika-custom-icon.css">
    <!-- wave CSS
		============================================ -->
    <link rel="stylesheet" href="/backend/css/wave/waves.min.css">
    <!-- main CSS
		============================================ -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <a href="#"><img src="/backend/img/logo/logo.png" alt="" /></a>
                    </div>
                </div>
                                ...
                                <div role="menu" class="dropdown-menu message-dd animated zoomIn">
                                    ...
                                    <div class="hd-message-info">
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="/backend/img/post/1.jpg" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                                                    <h3>David Belle</h3>
                                        ...
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="/backend/img/post/2.jpg" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                                        ...
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="/backend/img/post/4.jpg" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="realtime-wrap notika-shadow mg-t-30">
                        ...
                        <div class="realtime-country-ctn realtime-ltd-mg">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="/backend/img/country/1.png" alt="" /></span> <span>United States</span>
                                </div>
                        ...
                        <div class="realtime-country-ctn">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="/backend/img/country/2.png" alt="" /></span> <span>Australia</span>
                                </div>
                                <div class="realtime-bw">
                                    <span>Firefox</span>
                                </div>
                        ...
                        <div class="realtime-country-ctn">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="/backend/img/country/3.png" alt="" /></span> <span>Brazil</span>
                                </div>
                                <div class="realtime-bw">
                                    <span>Firefox</span>
                                </div>
                                    ...
                                    <ul class="conversation-list">
                                        <li class="clearfix">
                                            <div class="chat-avatar">
                                                <img src="/backend/img/post/1.jpg" alt="male">
                                                <i>10:00</i>
                                            </div>
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="/backend/img/post/2.jpg" alt="Female">
                                                <i>10:01</i>
                                            </div>
                                            <div class="conversation-text">
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="/backend/img/post/2.jpg" alt="male">
                                                <i>10:02</i>
                                            </div>
                                            <div class="conversation-text">
                                                <div class="ctext-wrap chat-widgets-cn">
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- meanmenu JS
		============================================ -->
    <script src="/backend/js/meanmenu/jquery.meanmenu.js"></script>
    <!-- counterup JS
		============================================ -->
    ...
    <!-- jvectormap JS
		============================================ -->
    <script src="/backend/js/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="/backend/js/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="/backend/js/jvectormap/jvectormap-active.js"></script>
    <!-- sparkline JS
		============================================ -->
    ...
    <!-- knob JS
		============================================ -->
    <script src="/backend/js/knob/jquery.knob.js"></script>
    <script src="/backend/js/knob/jquery.appear.js"></script>
    <script src="/backend/js/knob/knob-active.js"></script>
    <!--  wave JS
		============================================ -->
    <script src="/backend/js/wave/waves.min.js"></script>
    <script src="/backend/js/wave/wave-active.js"></script>
    <!--  todo JS
		============================================ -->
    <script src="/backend/js/todo/jquery.todo.js"></script>
    <!-- plugins JS
		============================================ -->
    <script src="/backend/js/plugins.js"></script>
	<!--  Chat JS
		============================================ -->
    <script src="/backend/js/chat/moment.min.js"></script>
    <script src="/backend/js/chat/jquery.chat.js"></script>
    <!-- main JS
		============================================ -->
